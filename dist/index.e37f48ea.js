...
const init = function() {
    ...
    // Za hash i load
    (0, _recipeViewJsDefault.default).addHandlerRender(contorlRecipes);
...
const loadRecipe = async function(id) {
    try {
        ...
        // Svaki put se louduje sa APIja recept, pa nestane bookmarked, jer je on u kodu dodat, zatim se proverava da li u nizu bookmarks postoji recept sa istim ajdijem, ako da, onda mu se doda vrednost true, kako bi kasnije u htmlu moglo da se updajtuje sa fill klasom
...
const KEY = "8de23056-7e03-4378-8e07-fbf2099822b3";
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    addHandlerRender(handler) {
        // load je kada se kada se refresuje stranica, pa id koji je na tabu da se louduje, a hash osluskuje kad se promeni
        [
            "hashchange",
            "load"
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","../helpers.js":"hGI1E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg"); //Parcel 2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
   ...
   */ render(data, render = true) {
    ...
    update(data) {
        ...
        newElements.forEach((newEl, i)=>{
            ...
            // isEqualNode testira da li su isti newEl i curEl
            // u drugom usluvu, nodeValue vraca nam vrednost da je tekst, a ne neki HTML el. i ne sme da bude prazan string
            // Updates change TEXT
            if (!newEl.isEqualNode(curEl) && newEl.firstChild?.nodeValue.trim() !== "") curEl.textContent = newEl.textContent;
            // Updates change ATTRIBUES
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
      ...
      `;
        // Last page , ako je samo 1 str, zato se stavi ovo iza &&, da bi poguralo do poslednjeg jer nema vise od 1 str
...
exports.default = new BookmarksView(); // Ova klasa radi sve isto kao ResultsView samo renderuje podatke na drugom parentEl
